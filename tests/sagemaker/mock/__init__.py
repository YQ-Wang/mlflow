...
class TransformJob(TimestampedResource):
    ...
    def __init__(
        ...
        :param transform_resources: The ML instance types and instance count to use for
                                the transform job.
        :param data_processing: The data structure to specify the inference data and associate
                                data to the prediction results.
